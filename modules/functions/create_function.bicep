...
resource r_fn_app_settings 'Microsoft.Web/sites/config@2021-03-01' = {
  ...
  properties: {
    ...
    QUEUE_TRIGGER_CONNECTION__fullyQualifiedNamespace: '${svc_bus_ns_name}.servicebus.windows.net'
    QUEUE_TRIGGER_CONNECTION__credential: 'managedidentity'
    QUEUE_TRIGGER_CONNECTION__clientId: r_userManagedIdentity.properties.clientId
